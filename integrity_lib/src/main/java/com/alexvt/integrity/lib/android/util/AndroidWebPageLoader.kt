 ...
 */
class AndroidWebPageLoader(
        private val context: Context,
        private val webView: WebView?
) : WebPageLoader {

    constructor(webView: WebView) : this(webView.context, webView)
     ...
     */
    override fun loadHtml(startUrl: String, urlRedirectMap: Map<String, String>,
     ...
     */
    override fun getHtml(url: String, loadImages: Boolean,
    ...
    private fun loadPageInternal(webView: WebView, startUrl: String,
        ...
        this@AndroidWebPageLoader.pageLoadListener = pageLoadListener
    ...
    private fun startLoadingTimeoutTimer(webView: WebView) {
        ...
        loadingTimeoutTimer = Timer().schedule(loadingTimeoutMillis) {
                    GlobalScope.launch(Dispatchers.Main) {
                        android.util.Log.v("WebPageLoader", "Web page loading timeout\n" +
                                "exceeded $loadingTimeoutMillis ms: ${webView.url}")
