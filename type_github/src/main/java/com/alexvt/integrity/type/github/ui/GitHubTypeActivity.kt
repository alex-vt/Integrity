...
package com.alexvt.integrity.type.github.ui
...
class GitHubTypeActivity : DataTypeActivity() {
    ...
    private fun goToGitHubUserPage(snapshot: SnapshotMetadata, userName: String): Boolean {
        AndroidWebPageLoader(content.webView).loadHtml(LinkUtil.getFullFormUrl("https://github.com/$userName"),
                emptyMap<String, String>(), true, false) {
